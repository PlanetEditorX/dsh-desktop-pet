...
.dp-img-wrap{position:relative;width:100%;height:100%;display:flex;align-items:flex-end;justify-content:center}
.dp-whale-img{height:96%;max-width:100%;object-fit:contain;transition:transform .9s ease}
...
`;
    ...
    // ------------------------------------------------------------------
    function Whale({ phase, dragging, imageSrc, imgFailed }) {
      const open = dragging;
      ...
      return e('div', null,
        e('div', { className: windowOpen ? 'dp-root hidden' : 'dp-root' },
          e('div', {
            ...
            e(Whale, { phase, dragging: dragOver, imageSrc: imgSrc, imgFailed }),
          ),
        ),
        windowOpen
